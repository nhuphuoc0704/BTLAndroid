...
public class Movie implements Serializable {
    ...
    public Movie(float star,float total_star, String name, String director, String writers, String trailer, String storyline, String image,String stars, int ratings, String release_date, String duration) {
        this.star = star;
        this.name = name;
